#ifndef XIAOMIREMOTESWITCH_H
#define XIAOMIREMOTESWITCH_H
...
class XiaomiRemoteSwitch : public QObject
{
    Q_OBJECT
public:
    explicit XiaomiRemoteSwitch(ZigbeeNode *node, QObject *parent = nullptr);
